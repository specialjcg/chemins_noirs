...
echo ""
echo "Features:"
echo "  - 🎨 Elm MVU architecture (pure functional, source de verite du state)"
echo "  - 🔧 Development mode (hot reload, Elm debugger)"
echo "  - 🗺️  Carte 2D : MapLibre GL JS (planning + topo overlay course d'orientation)"
echo "  - 🌄 Vue 3D Course d'Orientation : Three.js (terrain DEM + routes + vegetation + batiments)"
