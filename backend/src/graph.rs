...
// Geofabrik France regions (pre-2016 names) with approximate bounding boxes
const FRANCE_REGIONS: &[RegionPbf] = &[
    RegionPbf { name: "Rhône-Alpes",          filename: "rhone-alpes-latest.osm.pbf",                url: "https://download.geofabrik.de/europe/france/rhone-alpes-latest.osm.pbf",                min_lat: 44.12, max_lat: 46.52, min_lon: 4.23, max_lon: 7.18 },
    RegionPbf { name: "Auvergne",             filename: "auvergne-latest.osm.pbf",                   url: "https://download.geofabrik.de/europe/france/auvergne-latest.osm.pbf",                   min_lat: 44.68, max_lat: 46.80, min_lon: 2.05, max_lon: 4.37 },
    RegionPbf { name: "PACA",                 filename: "provence-alpes-cote-d-azur-latest.osm.pbf", url: "https://download.geofabrik.de/europe/france/provence-alpes-cote-d-azur-latest.osm.pbf", min_lat: 43.10, max_lat: 45.20, min_lon: 4.20, max_lon: 7.70 },
    RegionPbf { name: "Languedoc-Roussillon", filename: "languedoc-roussillon-latest.osm.pbf",        url: "https://download.geofabrik.de/europe/france/languedoc-roussillon-latest.osm.pbf",        min_lat: 42.33, max_lat: 45.05, min_lon: 1.35, max_lon: 4.84 },
    RegionPbf { name: "Midi-Pyrénées",        filename: "midi-pyrenees-latest.osm.pbf",               url: "https://download.geofabrik.de/europe/france/midi-pyrenees-latest.osm.pbf",               min_lat: 42.33, max_lat: 45.05, min_lon: -0.02, max_lon: 3.40 },
    RegionPbf { name: "Aquitaine",            filename: "aquitaine-latest.osm.pbf",                   url: "https://download.geofabrik.de/europe/france/aquitaine-latest.osm.pbf",                   min_lat: 42.78, max_lat: 45.75, min_lon: -1.88, max_lon: 2.50 },
    RegionPbf { name: "Poitou-Charentes",     filename: "poitou-charentes-latest.osm.pbf",            url: "https://download.geofabrik.de/europe/france/poitou-charentes-latest.osm.pbf",            min_lat: 45.00, max_lat: 47.18, min_lon: -1.85, max_lon: 1.50 },
    RegionPbf { name: "Bourgogne",            filename: "bourgogne-latest.osm.pbf",                   url: "https://download.geofabrik.de/europe/france/bourgogne-latest.osm.pbf",                   min_lat: 46.16, max_lat: 48.40, min_lon: 2.84, max_lon: 5.50 },
    RegionPbf { name: "Franche-Comté",        filename: "franche-comte-latest.osm.pbf",               url: "https://download.geofabrik.de/europe/france/franche-comte-latest.osm.pbf",               min_lat: 46.24, max_lat: 48.07, min_lon: 5.35, max_lon: 7.65 },
    RegionPbf { name: "Alsace",               filename: "alsace-latest.osm.pbf",                      url: "https://download.geofabrik.de/europe/france/alsace-latest.osm.pbf",                      min_lat: 47.42, max_lat: 48.98, min_lon: 6.84, max_lon: 8.24 },
    RegionPbf { name: "Lorraine",             filename: "lorraine-latest.osm.pbf",                    url: "https://download.geofabrik.de/europe/france/lorraine-latest.osm.pbf",                    min_lat: 47.87, max_lat: 49.70, min_lon: 4.90, max_lon: 7.64 },
    RegionPbf { name: "Champagne-Ardenne",    filename: "champagne-ardenne-latest.osm.pbf",           url: "https://download.geofabrik.de/europe/france/champagne-ardenne-latest.osm.pbf",           min_lat: 47.70, max_lat: 50.17, min_lon: 3.35, max_lon: 5.89 },
    ...
    RegionPbf { name: "Centre",               filename: "centre-latest.osm.pbf",                      url: "https://download.geofabrik.de/europe/france/centre-latest.osm.pbf",                      min_lat: 46.34, max_lat: 48.52, min_lon: 0.05, max_lon: 3.40 },
    RegionPbf { name: "Limousin",             filename: "limousin-latest.osm.pbf",                    url: "https://download.geofabrik.de/europe/france/limousin-latest.osm.pbf",                    min_lat: 44.96, max_lat: 46.40, min_lon: 0.84, max_lon: 2.60 },
    RegionPbf { name: "Picardie",             filename: "picardie-latest.osm.pbf",                    url: "https://download.geofabrik.de/europe/france/picardie-latest.osm.pbf",                    min_lat: 49.07, max_lat: 50.40, min_lon: 1.40, max_lon: 4.30 },
    RegionPbf { name: "Nord-Pas-de-Calais",   filename: "nord-pas-de-calais-latest.osm.pbf",          url: "https://download.geofabrik.de/europe/france/nord-pas-de-calais-latest.osm.pbf",          min_lat: 49.97, max_lat: 51.10, min_lon: 1.56, max_lon: 4.27 },
    RegionPbf { name: "Haute-Normandie",      filename: "haute-normandie-latest.osm.pbf",             url: "https://download.geofabrik.de/europe/france/haute-normandie-latest.osm.pbf",             min_lat: 48.68, max_lat: 50.07, min_lon: -0.06, max_lon: 2.00 },
    RegionPbf { name: "Basse-Normandie",      filename: "basse-normandie-latest.osm.pbf",             url: "https://download.geofabrik.de/europe/france/basse-normandie-latest.osm.pbf",             min_lat: 48.10, max_lat: 49.78, min_lon: -2.00, max_lon: 0.92 },
